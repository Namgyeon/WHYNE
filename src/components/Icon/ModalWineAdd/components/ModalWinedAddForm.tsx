...
export default function ModalWineAddForm({ onSubmit }: ModalWineFormProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between gap-[3%] h-[54px]">
        <Button
          variant="modalCancel"
          className="w-[27%] h-full bg-purple-10 text-purple-100 border-none hover:border-purple-100"
        >
          취소
        </Button>
